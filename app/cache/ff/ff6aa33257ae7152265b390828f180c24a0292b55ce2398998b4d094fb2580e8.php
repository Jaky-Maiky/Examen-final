...
class __TwigTemplate_afed7f07b41d0a31ba145464a0af2e110aaa951e93e8a4fb38a854b4402d9bfa extends Twig_Template
{
...
";
        ...
        // line 46
        echo "    <p>";
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("No images in the list, yet.");
        echo "</p>
";
...
";
        // line 66
        $context["listdata"] = array("message" => array("remove" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Are you sure you want to remove this image?"), "removeMulti" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Are you sure you want to remove these images?"), "wrongtype" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("There was an error uploading the file.
Make sure that the file type is of:
%typelist%", array("%typelist%" => (($this->getAttribute(        // line 70
(isset($context["option"]) ? $context["option"] : null), "extensions", array())) ? (("." . twig_join_filter($this->getAttribute((isset($context["option"]) ? $context["option"] : null), "extensions", array()), ", ."))) : ("–"))))), "empty" => twig_trim_filter(        // line 72
(isset($context["list_empty"]) ? $context["list_empty"] : null)), "item" => $this->env->getExtension('Bolt\Twig\TwigExtension')->pregReplace(twig_trim_filter(        // line 73
(isset($context["list_item"]) ? $context["list_item"] : null)), "/>\\s+</", "><"), "itemUploading" => $this->env->getExtension('Bolt\Twig\TwigExtension')->pregReplace(twig_trim_filter(        // line 74
...
", "editcontent/fields/_imagelist.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/fields/_imagelist.twig");
    }
}
