...
class __TwigTemplate_e9a4f1af819257f56b6ca91f9d4e936de58fcd7e1c2bdbfad9d17398da5ab9b6 extends Twig_Template
{
...
";
    ...
    ";
        ...
        ";
            ...
            <li>Called from ";
                        // line 140
                        echo ((($this->getAttribute($context["call"], "file", array(), "any", true, true) && $this->getAttribute($context["call"], "line", array(), "any", true, true))) ? ($this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->formatFile($this->getAttribute($context["call"], "file", array()), $this->getAttribute($context["call"], "line", array()), (isset($context["from"]) ? $context["from"] : null))) : ((isset($context["from"]) ? $context["from"] : null)));
                        echo "</li>
...
{% macro display_message(log_index, log, is_deprecation) %}
    ...
    {% endif %}
{% endmacro %}
", "@WebProfiler/Collector/logger.html.twig", "/var/www/vendor/symfony/web-profiler-bundle/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/logger.html.twig");
    }
}
