...
class __TwigTemplate_1a5f35fad84bc72cced64baf3bcf72437404e8445573fb1b09060cfd8ecae520 extends Twig_Template
{
    ...
    <table>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["template"]) {
            ...
            if ($this->getAttribute($context["template"], "path", array(), "any", true, true)) {
                // line 100
                echo "                    <a href=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\CodeExtension')->getFileLink($this->getAttribute($context["template"], "path", array()), 1), "html", null, true);
                echo "\">
                        ";
                // line 101
...
{% endblock %}
", "@BoltProfiler/toolbar/twig.html.twig", "/var/www/vendor/bolt/bolt/app/view/toolbar/twig.html.twig");
    }
}
