...
class __TwigTemplate_1c56cda5ec1dc4f4f8783f44250a210c3debd5ea1a58bdb37f1995a2ef0a3ec4 extends Twig_Template
{
    ...
    ";
        // line 28
        $context["bind_data"] = array("savedon" => ((($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Saved on:") . " <strong></strong> <small>(") .         // line 29
(isset($context["dateChanged"]) ? $context["dateChanged"] : null)) . ")</small></p>"), "newRecord" => ((($this->getAttribute($this->getAttribute(        // line 30
(isset($context["context"]) ? $context["context"] : null), "content", array()), "id", array()) != 0)) ? (false) : (true)), "msgNotSaved" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("contenttypes.generic.saving-impossible", array("%contenttype%" => $this->getAttribute($this->getAttribute(        // line 31
...
(isset($context["context"]) ? $context["context"] : null), "has", array()), "tabs", array())) ? (" tab-content") : (""))), "enctype" => "multipart/form-data", "id" => "editcontent", "method" => "post", "role" => "form");
    ...
    ";
        ...
        echo "        <div id=\"%NOTICE_ID%\" class=\"alert alert-danger\">
            ...
            <label for=\"%FIELD_ID%\">";
        // line 48
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Field “%FIELD_NAME%”:");
        echo "</label>
            %MESSAGE%
        </div>
    ";
    ...
    ";
        // line 53
        echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->addData("validation", array("alertbox" => twig_trim_filter(        // line 54
(isset($context["alertbox"]) ? $context["alertbox"] : null)), "generic_msg" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Is required or needs to match a pattern!"))), "html", null, true);
        // line 56
        echo "
    ";
        // line 57
...
{% endblock %}
", "editcontent/editcontent.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/editcontent.twig");
    }
}
