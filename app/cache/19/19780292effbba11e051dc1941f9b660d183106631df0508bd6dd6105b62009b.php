...
class __TwigTemplate_18243819fc7d2c60aa88895445c202d7bf7b59f8a6d112938776e7f47a4017d5 extends Twig_Template
{
...
";
    ...
    ";
        ...
        // line 24
        echo "    ";
        $context["__internal_1c06e4ef67a94ccf4e6ee8b86b3cd8e101228561616cecb940bac72a89b2e37e"] = $this->loadTemplate("changelog/_macros.twig", "components/panel-lastmodified.twig", 24);
        // line 25
        echo "
    <ul>
        ";
            ...
            foreach ($context['_seq'] as $context["index"] => $context["entry"]) {
                ...
                if ((($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "filtered", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "filtered", array()))) : (""))) {
                    ...
                    if ($this->getAttribute($context["entry"], "title", array())) {
                        ...
                        // line 36
                        echo "                            ";
                        $context["title"] = $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("%name% № %id%", array("%name%" => $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "contenttype", array()), "singular_name", array()), "%id%" => $this->getAttribute($context["entry"], "contentid", array())));
                        // line 37
                        echo "                        ";
                    }
                    // line 38
                ...
                echo "
                    ";
                // line 41
                echo $context["__internal_1c06e4ef67a94ccf4e6ee8b86b3cd8e101228561616cecb940bac72a89b2e37e"]->getchangelog_mutation($this->getAttribute($context["entry"], "mutation_type", array()));
                echo "
                    ";
                // line 42
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("by");
                echo " ";
    ...
    ";
        ...
        if ((($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "changelog", array(), "any", true, true) && $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "contentid", array())) && $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "filtered", array()))) {
            ...
            ";
            // line 63
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Full list …");
            echo "
        </a>
    ";
        }
...
{% endblock panel_body %}
", "components/panel-lastmodified.twig", "/var/www/vendor/bolt/bolt/app/view/twig/components/panel-lastmodified.twig");
    }
}
