...
class __TwigTemplate_b183c0af28e38a60158624ee80dcd5397a5010f05542b2e98eff78909466bb00 extends Twig_Template
{
        ...
        <div class=\"form-group\" data-fieldtype=\"";
            ...
            ";
                ...
                if (($this->getAttribute($context["field"], "prefix", array(), "any", true, true) &&  !twig_test_empty($this->getAttribute($context["field"], "prefix", array())))) {
                    ...
                    ";
                    // line 10
                    echo $this->env->getExtension('Bolt\Twig\TwigExtension')->markdown($this->getAttribute($context["field"], "prefix", array()));
                    echo "
                </div>
            ";
                }
            ...
            ";
                // line 15
                echo "            ";
                $context["labelkey"] = (($this->getAttribute($context["field"], "label", array())) ? ($this->getAttribute($context["field"], "label", array())) : ($this->env->getExtension('Bolt\Twig\TwigExtension')->ucfirst($context["key"])));
                // line 16
                echo "
            ";
                // line 17
...
$context["key"])));
            ...
            ";
                ...
                if (($this->getAttribute($context["field"], "postfix", array(), "any", true, true) &&  !twig_test_empty($this->getAttribute($context["field"], "postfix", array())))) {
                    ...
                    ";
                    // line 30
                    echo $this->env->getExtension('Bolt\Twig\TwigExtension')->markdown($this->getAttribute($context["field"], "postfix", array()));
                    echo "
                </div>
            ";
                }
...
{% for key, field in context.contenttype.fields %}
    ...
    {% endif %}
{% endfor %}
", "editcontent/_fields.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/_fields.twig");
    }
}
