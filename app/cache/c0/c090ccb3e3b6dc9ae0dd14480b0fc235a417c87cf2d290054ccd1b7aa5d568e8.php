...
class __TwigTemplate_de23ef80739489a35c4079c3aa54e73b8f63a9f2228d8377bff4b8262798cfe1 extends Twig_Template
{
...
";
            // line 10
            echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->addData("recordlisting", array("delete_one" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Are you sure you wish to delete this record? There is no undo."), "delete_mult" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Are you sure you wish to delete these records? There is no undo."))), "html", null, true);
            // line 13
            echo "
...
";
        ...
        <a href=\"#\" class=\"btn btn-silent-danger deletechosen showifchosen\" style=\"display:none;\">
            ...
            ";
                // line 38
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Delete selected");
                echo "
        </a>
    </div>
";
...
";
            // line 60
            $context["__internal_887b838c4c3a06449569ac06fe96e1a94d49b8a3d7626cdeecec9f7f2d407680"] = $this->loadTemplate("_macro/_pager.twig", "_sub/_editable_record_list.twig", 60);
            // line 61
            echo $context["__internal_887b838c4c3a06449569ac06fe96e1a94d49b8a3d7626cdeecec9f7f2d407680"]->getpager($this->getAttribute((isset($context["contenttype"]) ? $context["contenttype"] : null), "slug", array()));
            echo "
...
";
    ...
    {
        return new Twig_Source("{% macro editable_record_list(contenttype, multiplecontent, permissions, extra_classes) %}
{% set lastgroup = \"----\" %}
...
{% endmacro %}
", "_sub/_editable_record_list.twig", "/var/www/vendor/bolt/bolt/app/view/twig/_sub/_editable_record_list.twig");
    }
}
