...
/* users/users.twig */
class __TwigTemplate_96b045a1bc5cd9c8ac1eb46d6aebefdceaee2681b9230218dd9efce4a0c53f91 extends Twig_Template
{
    ...
    {
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("All users");
    }
    ...
    <div class=\"row\">
        ...
        echo "
            <h2><strong>";
        // line 23
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Roles and Permissions");
        echo "</strong></h2>
        ...
        echo "
            <h2><strong>";
        // line 27
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Current sessions");
        echo "</strong></h2>
...
{% endblock page_main %}
", "users/users.twig", "/var/www/vendor/bolt/bolt/app/view/twig/users/users.twig");
    }
}
