...
class __TwigTemplate_7e4983e0e7789f3bf162d89593a90746edd24e8474266aeecbae87403441e79d extends Twig_Template
{
...
";
        ...
        foreach ($context['_seq'] as $context["reltype"] => $context["ids"]) {
            ...
            if ( !$this->getAttribute($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "contenttype", array(), "any", false, true), "relations", array(), "any", false, true), $context["reltype"], array(), "array", true, true)) {
                // line 18
                echo "        <p>";
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("This record is related to:");
                echo "</p>
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["id"]) {
                    ...
                    if ((isset($context["record"]) ? $context["record"] : null)) {
                        // line 23
                        echo "                    ";
                        $context["editable"] = $this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed("edit", (isset($context["record"]) ? $context["record"] : null));
                        // line 24
                        echo "                    ";
...
{% if not context.has.tabs %}
    <hr>
{% endif %}
", "editcontent/_relations.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/_relations.twig");
    }
}
