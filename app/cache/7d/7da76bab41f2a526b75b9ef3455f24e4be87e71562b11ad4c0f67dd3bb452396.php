...
class __TwigTemplate_1052d8cecfbb08d99eb1bb4230498ee10b4200fd8d52fb20000700987f498ec8 extends Twig_Template
{
        ...
        if (array_key_exists("pager", $context)) {
            ...
            if (((isset($context["pager_ct"]) ? $context["pager_ct"] : null) && ($this->getAttribute((isset($context["pager_ct"]) ? $context["pager_ct"] : null), "totalpages", array()) > 1))) {
                ...
                echo "                                <span>
                                    ";
                // line 45
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Showing");
                echo " ";
                ...
                echo " ";
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("of");
                echo " ";
    ...
    <footer id=\"bolt-footer\" class=\"hidden-xs\">
        ...
        if ($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array()), "get", array(0 => "general/branding/provided_by/0"), "method")) {
            // line 68
            echo "            ";
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Provided by:");
            echo "
            <a href=\"mailto:";
            // line 69
        ...
        echo "</b>: ";
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Sophisticated, lightweight & simple CMS");
        echo " -
...
{% endblock page_plain %}
", "_base/_page-nav.twig", "/var/www/vendor/bolt/bolt/app/view/twig/_base/_page-nav.twig");
    }
}
