...
class __TwigTemplate_7b96ff54405ac31a1b4359170a67f05b0171d0030c1af577c935011e4c0998e3 extends Twig_Template
{
    ...
    <p style=\"margin-top: 15px;\"><strong>";
        // line 17
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Filter");
        echo "</strong></p>
    ...
    <form class=\"form-inline\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["taxonomy"]) {
            ...
            if (twig_test_iterable($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "config", array()), "get", array(0 => (("taxonomy/" . $context["taxonomy"]) . "/options")), "method"))) {
                ...
                ";
                // line 39
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("or");
                echo "
            ";
            }
            // line 41
        ...
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Keyword …");
        echo "\">
        </div>
        ...
        if ((($this->env->getExtension('Bolt\Twig\TwigExtension')->request("filter") || $this->env->getExtension('Bolt\Twig\TwigExtension')->request("order")) || (isset($context["taxonomyfilter"]) ? $context["taxonomyfilter"] : null))) {
            ...
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Clear sort/filter");
            echo "</a>
            ";
        }
        // line 51
    ...
    <p><strong>";
        // line 63
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Details");
        echo "</strong></p>
    <ul>
        <li>";
        // line 65
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Default status");
        echo ": ";
        ...
        <li>";
        // line 66
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Listing template");
        echo ": <code>";
        ...
        <li>";
        // line 67
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Detail template");
        echo ": <code>";
        ...
        if (twig_test_iterable((($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "contenttype", array(), "any", false, true), "taxonomy", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "contenttype", array(), "any", false, true), "taxonomy", array()), "")) : ("")))) {
            // line 69
            echo "            <li>";
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Taxonomy");
            echo ": ";
        ...
        if (twig_test_iterable((($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "contenttype", array(), "any", false, true), "relations", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "contenttype", array(), "any", false, true), "relations", array()), "")) : ("")))) {
            ...
            echo "            <li>
                ";
            // line 73
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Relationships");
            echo ":
                ";
            // line 74
            $context['_parent'] = $context;
...
{% endblock panel_body %}
", "overview/_panel-actions_overview.twig", "/var/www/vendor/bolt/bolt/app/view/twig/overview/_panel-actions_overview.twig");
    }
}
