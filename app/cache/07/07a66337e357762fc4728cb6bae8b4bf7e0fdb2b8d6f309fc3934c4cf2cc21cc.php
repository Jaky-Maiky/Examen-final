...
class __TwigTemplate_8eab2dc4a0b23613385ed1f9743c839f0f825e1b4e73b08bd3aaf3256bda6b2d extends Twig_Template
{
    ...
    ";
        // line 5
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\HttpKernelExtension')->renderFragment($this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("_wdt", array("token" => (isset($context["token"]) ? $context["token"] : null), "position" => "normal")));
        echo "
...
{% block body %}
    ...
    //]]></script>
{% endblock %}
", "@WebProfiler/Profiler/layout.html.twig", "/var/www/vendor/symfony/web-profiler-bundle/Symfony/Bundle/WebProfilerBundle/Resources/views/Profiler/layout.html.twig");
    }
}
