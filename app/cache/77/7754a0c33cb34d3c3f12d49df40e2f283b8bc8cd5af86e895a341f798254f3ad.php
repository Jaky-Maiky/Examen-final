...
class __TwigTemplate_dee4917ba0ae812fe19b84f1baddbf20509c8c5727b01fbed0c756c4b5e9e338 extends Twig_Template
{
...
(isset($context["taxonomy"]) ? $context["taxonomy"] : null), "multiple", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute((isset($context["taxonomy"]) ? $context["taxonomy"] : null), "multiple", array()), false)) : (false))) {
                ...
                ";
                    ...
                    <option value=\"\">";
                        // line 111
                        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("(no category)");
                        echo "</option>
...
{% if not context.has.tabs %}
    <hr>
{% endif %}
", "editcontent/_taxonomies.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/_taxonomies.twig");
    }
}
