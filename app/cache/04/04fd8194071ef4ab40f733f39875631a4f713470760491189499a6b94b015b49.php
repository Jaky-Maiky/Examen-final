...
class __TwigTemplate_a76fa9d3f136863deae59d46f2582a18fc5aef77d9fa2592a86a6c63297917dc extends Twig_Template
{
    ...
    {
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("logs.change-log");
    }
    ...
    ";
        // line 11
        $context["__internal_b087c18402efad2e2c765cdd884edca0c8111b5b4fc0d0fd1ac9bf8982a33f06"] = $this->loadTemplate("_macro/_pager.twig", "activity/changelog.twig", 11);
        // line 12
        echo "
    ";
        // line 13
    ...
    <div class=\"row\">
        ...
        // line 19
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("changelog", array("action" => "trim"));
        echo "\">
                    <i class=\"fa fa-trash-o\"></i> ";
        // line 20
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Trim Change Log");
        echo "
                </a>
                <a class=\"btn btn-default confirm\" href=\"";
        // line 22
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("changelog", array("action" => "clear"));
        echo "\" data-confirm=\"Are you sure you want to clear the change logs?\">
                    <i class=\"fa fa-trash\"></i> ";
        // line 23
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Clear Change Log");
        echo "
                </a>
            </div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["entry"]) {
            ...
            echo "
                        ...
                        <td>
                            ";
            // line 62
            $context["user"] = $this->env->getExtension('Bolt\Twig\TwigExtension')->getUser($this->getAttribute($context["entry"], "ownerid", array()));
            // line 63
            echo "                            ";
        ...
        echo "                </tbody>
            ...
            ";
        // line 78
        echo $context["__internal_b087c18402efad2e2c765cdd884edca0c8111b5b4fc0d0fd1ac9bf8982a33f06"]->getpager();
        echo "
...
";
    ...
    {
        return new Twig_Source("{# Page: NavSecondary > Dashboard > Configuration > Change Log #}
...
{% endblock page_main %}
", "activity/changelog.twig", "/var/www/vendor/bolt/bolt/app/view/twig/activity/changelog.twig");
    }
}
