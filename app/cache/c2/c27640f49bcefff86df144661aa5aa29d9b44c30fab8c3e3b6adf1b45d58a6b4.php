...
class __TwigTemplate_3bc3b82ea89534771c74734ff62ea70ed98366a92086046dbdcad24dcbf48b90 extends Twig_Template
{
...
";
        ...
        // line 6
        $context["can_publish"] = $this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed(((("contenttype:" . $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "contenttype", array()), "slug", array())) . ":publish:") . $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "content", array()), "id", array())));
        // line 7
        $context["can_depublish"] = $this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed(((("contenttype:" . $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "contenttype", array()), "slug", array())) . ":depublish:") . $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "content", array()), "id", array())));
        // line 8
        echo "
";
        // line 9
...
";
        // line 52
        $context["attr_ownerid"] = array("class" => "form-control narrow", "disabled" =>  !$this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed(((("contenttype:" . $this->getAttribute($this->getAttribute(        // line 54
...
";
        // line 58
        $context["attr_comment"] = array("class" => "form-control", "disabled" =>  !$this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed(((("contenttype:" . $this->getAttribute($this->getAttribute(        // line 60
(isset($context["context"]) ? $context["context"] : null), "contenttype", array()), "slug", array())) . ":change-ownership:") . $this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "content", array()), "id", array()))), "name_id" => "changelog-comment", "placeholder" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Add a brief, optional comment to describe what's changed."), "type" => "text");
        // line 65
        echo "
";
        // line 67
...
<h3>
    ";
        // line 69
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Meta information");
        echo "
</h3>
...
<div class=\"form-group\">
    ";
        // line 83
        echo $context["macro"]->getlabel($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Publication date:"), "", "col-sm-4 control-label");
        echo "
    <div class=\"col-sm-8\">
        ";
        // line 85
...
<div class=\"form-group depublish-group\">
    ";
        // line 90
        echo $context["macro"]->getlabel($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Depublication date:"), "", "col-sm-4 control-label");
        echo "
    <div class=\"col-sm-8\">
        ";
        // line 92
...
";
        ...
        ";
            // line 100
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("and edited");
            echo "
        ";
            // line 101
...
<div class=\"form-group\">
    ";
        // line 106
        echo $context["macro"]->getlabel($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Status:"), "", "col-sm-4 control-label");
        echo "
    <div class=\"col-sm-8\">
        <select";
        // line 108
...
<div class=\"form-group\">
    ";
        // line 121
        echo $context["macro"]->getlabel($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Owner:"), "", "col-sm-4 control-label");
        echo "
    <div class=\"col-sm-8\">
        <select";
        // line 123
...
";
        ...
        ";
            // line 137
            echo $context["macro"]->getlabel($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Add a comment:"), "", "col-sm-4 control-label");
            echo "
        <div class=\"col-sm-8\">
            <input";
            // line 139
...
{% endif %}
", "editcontent/_meta.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/_meta.twig");
    }
}
