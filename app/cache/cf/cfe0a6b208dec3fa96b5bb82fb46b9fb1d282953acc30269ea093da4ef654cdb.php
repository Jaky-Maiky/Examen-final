...
class __TwigTemplate_3c4274fba3cb79bbbbd00a17684eaf6efe6b9cdb49a4e86941cc455ecc06b9e9 extends Twig_Template
{
...
.sf-minitoolbar img {
    ...
    ";
        ...
        if ($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "editlink", array())) {
            ...
            echo "\">";
            echo twig_escape_filter($this->env, _twig_default_filter($this->env->getExtension('Bolt\Twig\TwigExtension')->excerpt($this->getAttribute((isset($context["collector"]) ? $context["collector"] : null), "edittitle", array()), 40), "(no title)"), "html", null, true);
            echo "</a>
        </div>
        ";
        }
    ...
    {
        return new Twig_Source("{% extends app.request.isXmlHttpRequest|default(false) ? '@WebProfiler/Profiler/ajax_layout.html.twig' : '@WebProfiler/Profiler/layout.html.twig' %}
...
", "@BoltProfiler/toolbar/bolt.html.twig", "/var/www/vendor/bolt/bolt/app/view/toolbar/bolt.html.twig");
    }
}
