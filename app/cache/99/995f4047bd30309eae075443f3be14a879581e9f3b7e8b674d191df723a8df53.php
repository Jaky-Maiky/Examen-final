...
class __TwigTemplate_30ef62d6bdc3c6945bae3d9db36c710335cd7a91f001be772b3d3fe8abcac49c extends Twig_Template
{
    ...
    {
        echo (($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "write_allowed", array())) ? ($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("page.edit-file.title.edit")) : ($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("page.edit-file.title.view")));
    }
    ...
    ";
        ...
        // line 14
        echo "    ";
        $context["__internal_30d07978d6e2d21cb0854a5c5dfa86884486f01417a3325d04a37c13129839bf"] = $this->loadTemplate("_macro/_files_path.twig", "editfile/editfile.twig", 14);
        // line 15
        echo "
    ";
        // line 16
        echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->addData("editcontent.msg", array("change_quit" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("You have unfinished changes on this page. If you continue without saving, you will lose these changes."), "saving" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Saving …"))), "html", null, true);
        // line 19
        echo "
...
(isset($context["context"]) ? $context["context"] : null), "write_allowed", array())) ? (false) : (true)))), "class" => "CodeMirror-scroll", "id" => "form_contents", "name" => "form[contents]", "required" => false, "style" => "width: 98%; min-height: 350px; white-space: pre; word-wrap: normal; overflow-x: scroll;");
    ...
    <div class=\"row\">
        ...
        echo "\"
                       href=\"";
        // line 48
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("fileedit", array("namespace" => $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "namespace", array()), "file" => $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "file", array()))), "html", null, true);
        echo "\"
                    >
        ...
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "filegroup", array())) > 1)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["related"]) {
                ...
                if (($context["related"] != $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "basename", array()))) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("fileedit", array("namespace" => $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "namespace", array()), "file" => ($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "additionalpath", array()) . $context["related"]))), "html", null, true);
                    echo "\">";
        ...
        echo "
                <strong>";
        // line 67
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->localeDateTime($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "datechanged", array()), "%c");
        echo "</strong>
                <small>(";
        // line 68
    ...
    ";
        // line 75
        if ( !$this->env->getExtension('Bolt\Twig\TwigExtension')->isMobileClient()) {
            // line 76
            echo "        ";
...
{% endblock page_main %}
", "editfile/editfile.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editfile/editfile.twig");
    }
}
