...
class __TwigTemplate_85e9c249a8fa2a0891679f30c07864455fd92455ffc25bbb48751cacc498a205 extends Twig_Template
{
    ...
    {
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Fill the database with Dummy Content");
    }
    ...
    <div class=\"row\">
        ...
        // line 40
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Deselect all");
        echo "</button>
                </div>
                <div style=\"margin-top: 12px\">
                    <button type=\"submit\" class=\"btn btn-primary\"><i class=\"fa fa-wrench\"></i> ";
        // line 43
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Prefill database");
        echo "</button>
                </div>
...
{% endblock page_main %}
", "prefill/prefill.twig", "/var/www/vendor/bolt/bolt/app/view/twig/prefill/prefill.twig");
    }
}
