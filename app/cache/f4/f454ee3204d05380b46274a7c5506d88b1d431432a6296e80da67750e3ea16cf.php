...
class __TwigTemplate_7b27bbb102353a8ade58dfb3189d027fc545aeabb2be1af33287fc4b056c5b66 extends Twig_Template
{
...
";
        ...
        if (twig_in_filter("geolocation", (isset($context["used_fieldtypes"]) ? $context["used_fieldtypes"] : null))) {
            // line 37
            echo "    ";
            echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->addData("field.geolocation.title-pin", $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("field.geolocation.title-pin")), "html", null, true);
            echo "
...
";
        ...
        if (twig_in_filter("slug", (isset($context["used_fieldtypes"]) ? $context["used_fieldtypes"] : null))) {
            // line 42
            echo "    ";
            echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->addData("field.slug.message.set", $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("field.slug.message.set")), "html", null, true);
            echo "
    ";
            // line 43
            echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->addData("field.slug.message.unlock", $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("field.slug.message.unlock")), "html", null, true);
            echo "
";
        }
    }
    ...
    {
        return new Twig_Source("{# Check which field types are used #}
...
{% endif %}
", "editcontent/_includes-data.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/_includes-data.twig");
    }
}
