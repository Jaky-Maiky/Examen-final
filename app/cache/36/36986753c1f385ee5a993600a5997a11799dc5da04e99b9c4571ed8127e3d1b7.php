...
/* files/files.twig */
class __TwigTemplate_2a1aa41aabf501958868519bf21cce2c8f9f3fc897d9de8350dc58ee1a5d086e extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 4
        $context["__internal_6583d8c1b2eb74f4aac15a5d20f9d324d8a0b3a9bf634a084e330f1708f86815"] = $this->loadTemplate("_macro/_files_path.twig", "files/files.twig", 4);
        // line 6
    ...
    {
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Files");
    }

    // line 11
    public function block_page_subtitle($context, array $blocks = array())
    {
        echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "namespace", array()) . "/") . $this->env->getExtension('Bolt\Twig\TwigExtension')->last(twig_get_array_keys_filter($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "pathsegments", array())))), "html", null, true);
    }
    ...
    ";
        // line 15
        echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->addData("files.msg.create_folder", $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Please enter a new folder name")), "html", null, true);
        echo "
    ";
        // line 16
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "folders", array())) > 0)) {
            // line 17
            echo "        ";
            echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->addData("files.msg.rename_folder", $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Please enter a new folder name!")), "html", null, true);
            echo "
        ";
            // line 18
    ...
    ";
        ...
        if ((twig_length_filter($this->env, $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "files", array())) > 0)) {
            // line 21
            echo "        ";
            echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->addData("files.msg.rename_file", $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Please enter a new file name!")), "html", null, true);
            echo "
        ";
            // line 22
    ...
    <div class=\"row\">
        ...
        echo "',
                                                    '";
        // line 37
        echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->last(twig_get_array_keys_filter($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "pathsegments", array()))), "html", null, true);
        echo "',
                                                    this);\">
                    <i class=\"fa fa-fw fa-plus\"></i>
                    ";
        // line 40
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Create folder");
        echo "
                </a>
            </p>
        ...
        if (($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "form", array()) != false)) {
            ...
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Uploading to this folder is not allowed.");
            echo "</p>
            ";
        }
        // line 54
...
{% endblock page_main %}
", "files/files.twig", "/var/www/vendor/bolt/bolt/app/view/twig/files/files.twig");
    }
}
