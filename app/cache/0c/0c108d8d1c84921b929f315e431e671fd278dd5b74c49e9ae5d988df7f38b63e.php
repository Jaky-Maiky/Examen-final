...
class __TwigTemplate_2f5754079121794af950d1025e1fc57a4856171f8c78ea41973ce27698f6129b extends Twig_Template
{
...
(isset($context["option"]) ? $context["option"] : null), "uses", array())));
    ...
    public function block_fieldset($context, array $blocks = array())
    {
        ...
        echo (($this->getAttribute((isset($context["option"]) ? $context["option"] : null), "viewless", array())) ? ($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Unique Alias")) : ($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("field.slug.permalink")));
        echo ":</label>
    <div class=\"col-sm-9\">
...
{% endblock fieldset %}
", "editcontent/fields/_slug.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/fields/_slug.twig");
    }
}
