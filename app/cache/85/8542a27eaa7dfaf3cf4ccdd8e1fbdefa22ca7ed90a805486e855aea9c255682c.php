...
class __TwigTemplate_e93d9a7147f875491884c8131af8e9e2ae5e9dfebf06fb1e3bb760378f796846 extends Twig_Template
{
...
(isset($context["name"]) ? $context["name"] : null) . "[file]"), "type" => "text", "placeholder" => ((($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("field.general.allowed-filetypes") . " ") . twig_join_filter($this->getAttribute(        // line 26
...
(isset($context["key"]) ? $context["key"] : null), "width" => (isset($context["preview_w"]) ? $context["preview_w"] : null), "height" => (isset($context["preview_h"]) ? $context["preview_h"] : null))), "data_url" => $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("upload", array("handler" => $this->getAttribute(        // line 33
...
<fieldset class=\"image\">
    ...
    <div class=\"col-xs-8\">
        ...
        ";
        // line 112
        echo $context["block"]->getserverselect((isset($context["key"]) ? $context["key"] : null), $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Cancel"));
        echo "
    </div>
    ...
    <div class=\"col-xs-4\">
        ...
        if (($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "content", array()), "get", array(0 => (isset($context["contentkey"]) ? $context["contentkey"] : null)), "method") != "")) {
            // line 120
            echo "                    ";
            $context["preview_path"] = $this->env->getExtension('Bolt\Twig\TwigExtension')->thumbnail($this->getAttribute((isset($context["image"]) ? $context["image"] : null), "file", array()), (isset($context["preview_w"]) ? $context["preview_w"] : null), (isset($context["preview_h"]) ? $context["preview_h"] : null), "c");
            // line 121
            echo "                ";
        } else {
            // line 122
...
";
    ...
    public function getimagepath($__labelkey__ = null, $__option__ = null, $__image__ = null, $__attr_inp__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 51
            echo "    <label>";
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Path to image file");
            echo "</label>
    <input";
            // line 52
        ...
        try {
            ...
            ";
                    ...
                    <div class=\"col-sm-2\">
                        ...
                        echo twig_escape_filter($this->env, (isset($context["key"]) ? $context["key"] : null), "html", null, true);
                        echo "[alt]\">";
                        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Alt");
                        echo "</label>
                    </div>
                    <div class=\"col-sm-10\">
                        <input type=\"text\" name=\"";
...
", "editcontent/fields/_image.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/fields/_image.twig");
    }
}
