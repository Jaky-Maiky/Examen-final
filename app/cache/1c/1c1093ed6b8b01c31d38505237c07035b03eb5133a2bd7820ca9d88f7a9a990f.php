...
class __TwigTemplate_6cc165823e2ab9b7c566619963d8b30abc0d3e93ffcaa5994f53085c787860b7 extends Twig_Template
{
...
$context["slug"])));
            ...
            ";
                    // line 46
                    $context["key"] = (($this->getAttribute($context["contenttype"], "show_in_menu", array())) ? ($this->getAttribute($context["contenttype"], "show_in_menu", array())) : ($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Other content")));
                    // line 47
                    echo "            ";
...
{% endfor %}
", "nav/_secondary-content.twig", "/var/www/vendor/bolt/bolt/app/view/twig/nav/_secondary-content.twig");
    }
}
