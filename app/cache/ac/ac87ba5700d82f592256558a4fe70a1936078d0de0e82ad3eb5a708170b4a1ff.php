...
class __TwigTemplate_0302af0362b44a06b00a8317f0af433639303eb352447ac4d1242be41eb0dbf8 extends Twig_Template
{
...
";
        // line 12
        $context["templateselectdata"] = array("message" => array("change" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("This template adds new fields. Save, then refresh to see these changes."), "warningChange" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("You may lose some of your template fields with this change. Go to the template section and note down the values before doing this."), "warning" => $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Warning")), "currentHas" => $this->getAttribute($this->getAttribute(        // line 18
...
<fieldset class=\"templateselect\">
    ...
    <div class=\"col-sm-9\">
        ...
        echo ">";
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("(default template)");
        echo "</option>
            <option";
        // line 49
...
", "editcontent/fields/_templateselect.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/fields/_templateselect.twig");
    }
}
