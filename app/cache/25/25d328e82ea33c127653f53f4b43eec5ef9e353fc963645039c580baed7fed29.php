...
/* files/_files.twig */
class __TwigTemplate_d39de38c120c3201335d78102a81fbec58986168b0a16b3787f23cfeb33276fd extends Twig_Template
{
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["file"]) {
            ...
            if (twig_in_filter($this->getAttribute($context["file"], "type", array()), array(0 => "jpeg", 1 => "jpg", 2 => "png", 3 => "gif"))) {
                ...
                if ($this->getAttribute($context["file"], "readable", array())) {
                    // line 21
                    echo "                            <a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->thumbnail($this->getAttribute($context["file"], "newpath", array()), 1000, 1000, "r"), "html", null, true);
                    echo "\"
                               class=\"magnific\"
                               title=\"Image: ";
                    // line 23
...
$context["file"], "type", array()), array(0 => "twig", 1 => "txt", 2 => "html", 3 => "md", 4 => "markdown", 5 => "json", 6 => "htm", 7 => "scss", 8 => "css", 9 => "less", 10 => "js", 11 => "yml"))) {
                ...
                if ($this->getAttribute($context["file"], "readable", array())) {
                    // line 36
                    echo "                            <a href=\"";
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("fileedit", array("namespace" => $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "namespace", array()), "file" => $this->getAttribute($context["file"], "newpath", array()))), "html", null, true);
                    echo "\">
                                <b>";
                    // line 37
                    echo $this->env->getExtension('Bolt\Twig\TwigExtension')->shy($this->env->getExtension('Bolt\Twig\TwigExtension')->excerpt($this->getAttribute($context["file"], "filename", array()), 80));
            ...
            if ($this->getAttribute($context["file"], "imagesize", array(), "any", true, true)) {
                // line 77
                echo "                        ";
                $context["thumb"] = $this->env->getExtension('Bolt\Twig\TwigExtension')->showImage($this->getAttribute($context["file"], "newpath", array()), 54, 40, "c");
                // line 78
                echo "                        <img ";
                ...
                echo " alt=\"";
                echo twig_escape_filter($this->env, $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Thumbnail"), "html_attr");
                echo "\">
                    ";
            }
            // line 80
            ...
            if (($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "form", array()) != false)) {
                ...
                echo "', this);\">
                                        ...
                                        ";
                // line 101
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Rename %foldername%", array("%foldername%" => $this->getAttribute($context["file"], "filename", array())));
                echo "
                                    </a>
                                </li>
                                <li>
                ...
                echo "', this);\">
                                        ...
                                        ";
                // line 107
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Delete %filename%", array("%filename%" => $this->getAttribute($context["file"], "filename", array())));
                echo "
                                    </a>
                                </li>
                                <li>
                ...
                echo "')\">
                                        ...
                                        ";
                // line 113
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Duplicate %filename%", array("%filename%" => $this->getAttribute($context["file"], "filename", array())));
                echo "
                                    </a>
                                </li>
                                <li class=\"divider\"></li>
                                <li>
                                    <a class=\"nolink\">
                                        ";
                // line 119
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Permissions");
                echo ":
                                        <strong><code>";
                // line 120
...
", "files/_files.twig", "/var/www/vendor/bolt/bolt/app/view/twig/files/_files.twig");
    }
}
