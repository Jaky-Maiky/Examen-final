...
class __TwigTemplate_297152f19cb20b533f44170351d7dec016d47af907b45a7a29e05605c649189b extends Twig_Template
{
    ...
    {
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Files on the stack");
    }
    ...
    public function block_panel_body($context, array $blocks = array())
    {
        ...
        if (!$context['_iterated']) {
            ...
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("There are no items on the Stack, yet.");
            echo "</div>
        ";
        }
    ...
    <div class=\"stack-buttons\">
        ...
        if ($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "canUpload", array())) {
            ...
            <span class=\"btn btn-tertiary fileinput-button\">
                ...
                <span>";
            // line 35
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Upload");
            echo "</span>
                <input id=\"fileupload-stack\"
                       ...
                       data-url=\"";
            // line 39
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getUrl("upload", array("namespace" => $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "namespace", array()))), "html", null, true);
            echo "\"
                       accept=\".";
            // line 40
        ...
        echo "browse/files?key=stack\" class=\"btn btn-tertiary\" data-toggle=\"modal\" data-target=\"#selectModal-stack\">
                ...
                ";
        // line 48
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Select");
        echo "
            </a>
        </div>
    </div>
...
{% endblock panel_body %}
", "components/panel-stack.twig", "/var/www/vendor/bolt/bolt/app/view/twig/components/panel-stack.twig");
    }
}
