...
class __TwigTemplate_f19e5cc61086df5c17f2a8169e908fb2585d44da9bc2e0103804bea085757372 extends Twig_Template
{
    ...
    ";
        ...
        ";
            ...
            if (($this->getAttribute($context["relation"], "prefix", array(), "any", true, true) &&  !twig_test_empty($this->getAttribute($context["relation"], "prefix", array())))) {
                ...
                ";
                // line 10
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->markdown($this->getAttribute($context["relation"], "prefix", array()));
                echo "
            </div>
        ";
            }
        ...
        ";
            ...
            ";
            // line 19
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["macro"]) ? $context["macro"] : null), "label", array(0 => $this->getAttribute($context["relation"], "label", array()), 1 => $this->env->getExtension('Bolt\Twig\TwigExtension')->ucfirst($context["relcontenttype"]), 2 => "col-sm-4 control-label", 3 => ("relation-" . $context["relcontenttype"])), "method"), "html", null, true);
            echo "
            <div class=\"col-sm-8\">
            ...
            echo "                    ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->env->getExtension('Bolt\Twig\TwigExtension')->listContent($context["relcontenttype"], $context["relation"], $this->getAttribute((isset($context["context"]) ? $context["context"] : null), "content", array())));
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                echo ">
                            ";
                // line 43
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->twig((isset($context["format"]) ? $context["format"] : null), array("item" => $context["item"]));
                echo "
                        </option>
                    ";
            }
        ...
        ";
            ...
            if (($this->getAttribute($context["relation"], "postfix", array(), "any", true, true) &&  !twig_test_empty($this->getAttribute($context["relation"], "postfix", array())))) {
                ...
                ";
                // line 68
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->markdown($this->getAttribute($context["relation"], "postfix", array()));
                echo "
            </div>
        ";
            }
...
", "editcontent/_relationships.twig", "/var/www/vendor/bolt/bolt/app/view/twig/editcontent/_relationships.twig");
    }
}
