...
/* nav/_secondary.twig */
class __TwigTemplate_aaf3a81bd22598081c59ce908c9bf0ae30785ac296dd1fc7513aa47d437dfe6a extends Twig_Template
{
...
<ul class=\"nav\">
    ";
        ...
        ";
            // line 10
            echo "        ";
            echo $context["nav"]->getlink("fa:dashboard", $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Dashboard"), "dashboard", ((isset($context["page_nav"]) ? $context["page_nav"] : null) == "Dashboard"));
            echo "
        ...
        ";
            ...
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("View site");
            echo "</a>
        </li>
        ...
        ";
            ...
            if ($this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed("settings")) {
                ...
                // line 27
                echo "            ";
                if (($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "extensions", array()), "hasMenuoptions", array()) || $this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed("extensions||extensions:config"))) {
                    // line 28
                    echo "                ";
                    ob_start();
            ...
            ";
                ...
                if ((((twig_trim_filter((isset($context["nav_config"]) ? $context["nav_config"] : null)) || twig_trim_filter((isset($context["nav_files"]) ? $context["nav_files"] : null))) || twig_trim_filter((isset($context["nav_trans"]) ? $context["nav_trans"] : null))) || twig_trim_filter((isset($context["nav_extend"]) ? $context["nav_extend"] : null)))) {
                    // line 34
                    echo "                ";
                    echo $context["nav"]->getheading($this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Settings"), "fa:wrench");
                    echo "
    ...
    ";
        ...
        ";
            ...
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Login");
            echo "</a>
        </li>
    ";
        }
...
";
    ...
    {
        return new Twig_Source("{% import 'nav/_macros.twig' as nav %}
...
", "nav/_secondary.twig", "/var/www/vendor/bolt/bolt/app/view/twig/nav/_secondary.twig");
    }
}
