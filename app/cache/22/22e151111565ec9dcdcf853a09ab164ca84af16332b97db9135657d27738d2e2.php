...
/* nav/_primary.twig */
class __TwigTemplate_61af051694b3d0f94931776ab796e20e93a8b326f14c7b912c641975b50b860a extends Twig_Template
{
...
<ul class=\"nav navbar-top-links navbar-right\">
    ...
    <li>
        ...
        // line 19
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Find");
        echo "…\">
    ...
    <li class=\"close-live-editor\">
        <a>
            ...
            ";
        // line 35
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Close editor");
        echo "
        </a>
    </li>
    ...
    <li class=\"dropdown\">
        ...
        // line 41
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trim($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "displayname", array()), 16);
        ...
        // line 50
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Logout");
        echo "</span>
                    </button>
                </form>
            </li>
...
", "nav/_primary.twig", "/var/www/vendor/bolt/bolt/app/view/twig/nav/_primary.twig");
    }
}
