...
class __TwigTemplate_a593fea0d824a2ce797c18d8b22122ce5f95c99db0ea278f04fe48b31eb25b2c extends Twig_Template
{
...
";
        // line 2
        if ($this->env->getExtension('Bolt\Twig\TwigExtension')->isAllowed("useredit")) {
            // line 3
        ...
        <ul class=\"dropdown-menu pull-right\">
            ...
            if (($this->getAttribute($this->getAttribute((isset($context["context"]) ? $context["context"] : null), "currentuser", array()), "id", array()) != $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()))) {
                ...
                if ($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "enabled", array())) {
                    ...
                    echo "                    <li>
                        <form action=\"";
                    // line 18
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("useraction", array("action" => "disable", "id" => $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()))), "html", null, true);
                    echo "\" method=\"post\">
                            ";
                    // line 19
                    ...
                    // line 21
                    echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Disable %username%", array("%username%" => $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "displayname", array())));
                    echo "</span>
                            </button>
                        </form>
                    </li>
                ";
                    ...
                    echo "                    <li>
                        <form action=\"";
                    // line 27
                    echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("useraction", array("action" => "enable", "id" => $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()))), "html", null, true);
                    echo "\" method=\"post\">
                            ";
                    // line 28
                    ...
                    echo "                            <button type=\"submit\" class=\"btn btn-block btn-link\">
                                <span class=\"pull-left\">";
                    // line 30
                    echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Enable %username%", array("%username%" => $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "displayname", array())));
                    echo "</span>
                            </button>
                        </form>
                    </li>
                ...
                echo "                <li>
                    <form action=\"";
                // line 36
                echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("useraction", array("action" => "delete", "id" => $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()))), "html", null, true);
                echo "\" method=\"post\">
                        ";
                // line 37
                ...
                echo "                        <button type=\"submit\" class=\"btn btn-block btn-link confirm\"
                        data-confirm=\"";
                // line 39
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Are you sure you want to delete %username%?", array("%username%" => $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "displayname", array())));
                echo "\" >
                            <span class=\"pull-left\">";
                // line 40
                echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Delete %username%", array("%username%" => $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "displayname", array())));
                echo "</span>
                        </button>
                    </form>
                </li>
            ...
            <li>
                <a class=\"nolink\">
                    ";
            // line 57
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Last known IP");
            echo ": <strong>";
...
(isset($context["context"]) ? $context["context"] : null), "currentuser", array()), "id", array()) == $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()))) {
        ...
        <i class=\"fa fa-edit\"></i> ";
            // line 64
            echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Profile");
            echo "
    </a>
";
        }
...
{% endif %}
", "users/_userlist-actions.twig", "/var/www/vendor/bolt/bolt/app/view/twig/users/_userlist-actions.twig");
    }
}
