...
/* _recordfooter.twig */
class __TwigTemplate_14fa03ef42a78802931f6d3bd54244fdddb57f53499472ed775053d08bb00050 extends Twig_Template
{
    ...
    ";
        ...
        // line 6
        echo "    ";
        $context["recdate"] = $this->env->getExtension('Bolt\Twig\TwigExtension')->localeDateTime($this->getAttribute((isset($context["record"]) ? $context["record"] : null), "datepublish", array()), "%A %B %e, %Y");
        // line 7
        echo "    ";
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Written by <em>%name%</em> on %date%", array("%name%" => $this->getAttribute($this->getAttribute((isset($context["record"]) ? $context["record"] : null), "user", array()), "displayname", array()), "%date%" => (isset($context["recdate"]) ? $context["recdate"] : null)));
        echo " <br>
    <a href=\"";
        // line 8
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["record"]) ? $context["record"] : null), "link", array()), "html", null, true);
        echo "\">";
        echo $this->env->getExtension('Bolt\Twig\TwigExtension')->trans("Permalink");
        echo "</a> -
    ";
        // line 11
        echo "    ";
...
", "_recordfooter.twig", "/var/www/public/theme/base-2014/_recordfooter.twig");
    }
}
